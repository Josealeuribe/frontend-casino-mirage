...
import { Gift, History, Home, LogOut, MapPin, Trophy, UserCircle } from "lucide-react";
      ...
      <div className="p-3" style={{ borderTop: "1px solid rgba(107,50,214,0.1)" }}>
        <div className="flex items-center gap-2.5 px-3 py-2 mb-1 rounded-xl" style={{ background: "rgba(107,50,214,0.06)" }}>
          ...
          <div className="overflow-hidden">
            <p className="text-xs font-medium truncate" style={{ color: "rgba(237,232,252,0.8)" }}>{user?.name ?? "Cliente"}</p>
            <p className="text-xs truncate" style={{ color: "rgba(237,232,252,0.3)" }}>Cliente</p>
          </div>
        </div>
        <button
